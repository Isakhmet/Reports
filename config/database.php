    ...
    */
    ...
    'connections' => [
        ...
        'oracle' => [
            ...
            'username' => env('ORACLE_DB_USERNAME', 'score_service'),
            'password' => env('ORACLE_DB_PASSWORD', 'score_service'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'schema' => 'public',
        ...
        'server_new' => [
            'driver' => 'mysql',
            'host' => env('SN_DB_HOST', '10.8.0.193'),
            'port' => env('SN_DB_PORT', '3306'),
            'database' => env('SN_DB_DATABASE', 'server_new'),
            'username' => env('SN_DB_USERNAME', 'server'),
            'password' => env('SN_DB_PASSWORD', 'hqp0lNrBFy9pPu1y'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'schema' => 'public',
