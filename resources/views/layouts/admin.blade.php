...
<div class="wrapper">
    <nav class="main-header navbar navbar-expand bg-dark navbar-light border-bottom elevation-2">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            <li class="nav-item">
    ...
    <footer class="main-footer">
        <strong> &copy;</strong> {{ trans('global.allRightsReserved') }}<a class="btn btn-sm btn-outline-success"
                                                                           href="https://prodengi.kz">prodengi.kz</a>
    </footer>
