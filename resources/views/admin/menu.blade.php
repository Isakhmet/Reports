<aside class="main-sidebar sidebar-dark-info elevation-5" style="min-height: 917px" >
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="{{ route("admin.home_admin") }}" class="nav-link {{ request()->is('admin') || request()->is('admin') ? 'active' : '' }}">
                ...
                @can('report_access')
                    <li class="nav-item has-treeview {{ request()->is('admin/report*') ? 'menu-open' : '' }} {{ request()->is('admin/category*') ? 'menu-open' : '' }}">
